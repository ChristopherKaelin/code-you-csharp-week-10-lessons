...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine($"1. Serialized account saved to: {accountFilePath}");
        ...
        {
            string displayMessage = "Deserialize the JSON try has thrown an Exception: " + ex.Message.Split('.')[0] + ".";
